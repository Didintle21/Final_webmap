...
lyr_SuburbBoundary_1.set('fieldAliases', {'Suburb Name': 'Suburb Name', '2018 Consumption (kl/month)': '2018 Consumption (kl/month)', 'Flushable Toilets Connected to Sewage (%)': 'Flushable Toilets Connected to Sewage (%)', 'Type of Consumer ': 'Type of Consumer ', 'Average Bill (ZAR) ': 'Average Bill (ZAR) ', });
lyr_Dams_2.set('fieldAliases', {'Name ': 'Name ', 'Location': 'Location', 'River': 'River', 'Capacity ': 'Capacity ', });
lyr_TreatmentCentres_3.set('fieldAliases', {'Suburb': 'Suburb', 'Country': 'Country', 'Treated Water (mL) ': 'Treated Water (mL) ', });
...
lyr_InformalSettlements_5.set('fieldAliases', {'Region': 'Region', 'Name of Settlement': 'Name of Settlement', });
lyr_SuburbBoundary_1.set('fieldImages', {'Suburb Name': 'TextEdit', '2018 Consumption (kl/month)': 'TextEdit', 'Flushable Toilets Connected to Sewage (%)': 'TextEdit', 'Type of Consumer ': 'TextEdit', 'Average Bill (ZAR) ': 'TextEdit', });
lyr_Dams_2.set('fieldImages', {'Name ': 'TextEdit', 'Location': 'TextEdit', 'River': '', 'Capacity ': 'Range', });
lyr_TreatmentCentres_3.set('fieldImages', {'Suburb': '', 'Country': '', 'Treated Water (mL) ': '', });
...
lyr_InformalSettlements_5.set('fieldImages', {'Region': 'TextEdit', 'Name of Settlement': 'TextEdit', });
lyr_SuburbBoundary_1.set('fieldLabels', {'Suburb Name': 'inline label - always visible', '2018 Consumption (kl/month)': 'inline label - always visible', 'Flushable Toilets Connected to Sewage (%)': 'inline label - always visible', 'Type of Consumer ': 'inline label - always visible', 'Average Bill (ZAR) ': 'inline label - always visible', });
lyr_Dams_2.set('fieldLabels', {'Name ': 'inline label - always visible', 'Location': 'inline label - always visible', 'River': 'inline label - always visible', 'Capacity ': 'inline label - always visible', });
lyr_TreatmentCentres_3.set('fieldLabels', {'Suburb': 'inline label - always visible', 'Country': 'inline label - always visible', 'Treated Water (mL) ': 'inline label - always visible', });
...
lyr_InformalSettlements_5.set('fieldLabels', {'Region': 'inline label - always visible', 'Name of Settlement': 'inline label - always visible', });
